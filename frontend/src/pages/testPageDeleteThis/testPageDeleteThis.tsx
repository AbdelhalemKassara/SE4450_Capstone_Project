...
export default function TestPageDeleteThis(): JSX.Element {
  ...
  useEffect(() => {
    (async () => {
      ...
      console.log("Dataset Query4:", await dataset.getAnswers("2022", "dc22_age_in_years"));
      console.log("Dataset Query5:", await dataset.getAnswersCount("2022", "dc22_age_in_years"), await dataset.getAnswers("2022", "dc22_age_in_years"));
      ...
      console.log("Dataset Query6:", await dataset.getTotalResponses("2022", "dc22_age_in_years"));
    })();
